...
public class Cliente3
{
    ...
    public static void main (String[] args)
    {
        ...
        /*TratadoraDeComunicadoDeReiniciar tratadoraDeComunicadoDeReiniciar = null;
        try
        {
            tratadoraDeComunicadoDeReiniciar = new TratadoraDeComunicadoDeReiniciar (servidor, pilhaDeDescarte);
        }
        catch (Exception erro)
        {} // sei que servidor foi instanciado

        tratadoraDeComunicadoDeReiniciar.start();*/
